...
class StudySkillsForm(forms.Form):
    def __init__(self, *args, **kwargs):
        ...
        "When working on an assessment, I am keeping in mind how best to inpress the Instructor.",
        ...
        "I look at the evidence carefully and try to reach my own conclusion about what I am studying.",
        "It is important for me to feel that I am doing as well as I really can on the courses here.",
        ...
        "Regularly I find myself thinking about ideas from lectures when I am doing other things.",
        "I think I am quite systematic and organised when it comes to revising for exams.",
        ...
        "I often worry about whether I will ever be able to cope with the work properly.",
        "Often I find myself questioning things I hear in lectures or read in books.",
        "I feel that I am getting on well, and this helps me put more effort into the work.",
        ...
        "I am good at following up some of the reading suggested by lecturers or tutors.",
        "I keep in mind who is going to mark an assignment and what they are likely to be looking for.",
        ...
        "I am not really sure what is important in lectures so I try to get down all I can.",
        ...
        "When I read, I examine the details carefully to see how they fit in with what is being said.",
        ...
        "I usually plan out my weeks work in advance, either on paper or in my head.",
        "I keep an eye open for what lecturers seem to think is important and concentrate on that.",
        "I am not really interested in this course, but I have to take it for other reasons.",
        ...
        "Often I lie awake worrying about work I think I will not be able to do.",
        "It is important for me to be able to follow the argument, or to see the reason behind things.",
        "I do not find it at all difficult to motivate myself.",
        ...
        "exams which allow me to show that I have thought about the course material for myself.",
        "exams or tests which need only the material provided in our lecture notes.",
        "courses in which it is made very clear just which books we have to read.",
